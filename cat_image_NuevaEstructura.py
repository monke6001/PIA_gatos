...
def fetch_cat_images(params):
    ...
    try:
        ...
        # Guardar datos esenciales en archivo JSON
        with open("cat_data_clean.json", "w", encoding="utf-8") as f:
            json.dump(cat_data_analysis, f, ensure_ascii=False, indent=4)
        print("✅ Datos esenciales guardados en 'cat_data_clean.json'.")
